...
class RestorationArea():
    ...
    def _within(self, stack: xr.DataArray) -> bool:
        ...
        """
        if not (stack.yearcomp.contains_spatial(self.restoration_polygon) and
                    stack.yearcomp.contains_temporal(self.restoration_year) and
                        stack.yearcomp.contains_temporal(
